...
namespace MarketMonitor.Database.Migrations
{
    ...
    [Migration("20250506183156_Listing composite key")]
    partial class Listingcompositekey
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MarketMonitor.Database.Entities.CharacterEntity", b =>
                {
                    ...
                    b.Property<bool>("SaleNotification")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("UndercutNotification")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("MarketMonitor.Database.Entities.SaleEntity", b =>
                {
                    ...
                    b.Property<string>("ListingRetainerName")
                        .IsRequired()
                        .HasColumnType("varchar(64)");

                    b.HasKey("Id");

                    b.HasIndex("ListingId", "ListingRetainerName");
            ...
            modelBuilder.Entity("MarketMonitor.Database.Entities.SaleEntity", b =>
                {
                    b.HasOne("MarketMonitor.Database.Entities.ListingEntity", "Listing")
                        .WithMany()
                        .HasForeignKey("ListingId", "ListingRetainerName")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
